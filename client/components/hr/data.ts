...
export const profile: SubpageData = {
  ...
  cta: "Edit profile",
  stats: [
    { label: "Employee ID", value: "HRA-0103", sub: "People operations Â· HR Admin" },
  ...
  rows: [
    [{ text: "Employment contract", sub: "PDF Â· signed", weight: 600 }, { text: "Contract" }, { text: "Jun 2022" }, { tag: "Current", tone: "green" }],
    [{ text: "Tax withholding form", sub: "W-4", weight: 600 }, { text: "Tax" }, { text: "Jan 2026" }, { tag: "Current", tone: "green" }],
    [{ text: "Direct deposit details", sub: "â€¢â€¢â€¢â€¢ 3390", weight: 600 }, { text: "Banking" }, { text: "Jan 2026" }, { tag: "Verified", tone: "green" }],
